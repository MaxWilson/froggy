...
let view model d =
  R.div []
      [ R.div [] [ R.str <| descr model ]
        R.button [ OnClick (fun _ -> d <| AlterPCNumber +1) ] [ R.str "Add PC" ]
        R.button [ OnClick (fun _ -> d <| AlterPCNumber -1) ] [ R.str "Remove PC" ]
        R.button [ OnClick (fun _ -> d <| AlterLevel +1) ] [ R.str "Stronger PCs" ]
        R.button [ OnClick (fun _ -> d <| AlterLevel -1) ] [ R.str "Weaker PCs" ]
